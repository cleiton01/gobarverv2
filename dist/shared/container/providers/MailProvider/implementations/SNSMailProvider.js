...
var SNSMailProvider = /** @class */ (function () {
    function SNSMailProvider(mailTemplateProvider) {
        var _this = this;
    ...
    SNSMailProvider.prototype.sendMail = function (_a) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = {
                            from: {
                                name: (from === null || from === void 0 ? void 0 : from.name) || 'Cleiton Silva',
                                address: (from === null || from === void 0 ? void 0 : from.email) || 'clleiton.silva@gmail.com',
                            },
                            to: {
                                name: to.name,
                                address: to.email,
    ...
    SNSMailProvider = __decorate([
        __param(0, tsyringe_1.inject('MailTemplateProvider')),
        __metadata("design:paramtypes", [Object])
    ], SNSMailProvider);
    return SNSMailProvider;
}());
exports.default = SNSMailProvider;
