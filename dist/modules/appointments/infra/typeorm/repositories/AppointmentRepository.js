...
var AppoinmentsRepository = /** @class */ (function () {
    function AppoinmentsRepository() {
    }
    AppoinmentsRepository.prototype.constructir = function () {
        this.ormRepository = typeorm_1.getRepository(Appointment_1.default);
    };
    AppoinmentsRepository.prototype.findByDate = function (date) {
    ...
    AppoinmentsRepository.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AppoinmentsRepository.prototype.create = function (_a) {
    ...
    AppoinmentsRepository.prototype.findAllInMonthFromProvider = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                appointments = this.ormRepository.find({
                    where: {
                        provider_id: provider_id,
                        date: typeorm_1.Raw(function (dataFieldName) { return "to_char(" + dataFieldName + ", 'MMYYYY') = '" + parsedMonth + year + "'"; }),
                    }
                });
    ...
    ;
    return AppoinmentsRepository;
}());
exports.default = AppoinmentsRepository;
