...
var AppointmentController = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        parsedDate = date_fns_1.startOfHour(date_fns_1.parseISO(date));
    ...
    AppointmentController.prototype.find = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                //const appointments = await appoinmentsRepository.findAll();
                return [2 /*return*/, res.json({ appointments: 'ola' })];
            });
        });
    };
