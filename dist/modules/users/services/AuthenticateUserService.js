            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default(String(process.env.USER_PASS_INCORRECT), Number(process.env.USER_PASS_INCORRECT_STATUS));
                        }
                    ...
                    case 2:
                        ...
                        token = jsonwebtoken_1.sign({}, String(process.env.APP_SECRECT), {
                            subject: user.id,
                            expiresIn: '5d',
                        });
                        return [2 /*return*/, {
