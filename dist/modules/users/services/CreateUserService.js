...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var checkIfUserExists, hashedPassword, user;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (checkIfUserExists) {
                            throw new AppError_1.default(String(process.env.USER_ALREADY_EXISTIS), Number(process.env.USER_ALREADY_EXISTIS_STATUS));
                        }
