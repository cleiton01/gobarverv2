...
describe('CreateUser', function () {
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeHashProvider, createUser, user;
    ...
    it('should not be able to create a new user with same e-mail', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeHashProvider, createUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRespository = new FakeUsersRepository_1.default();
