...
describe('UpdateUserAvatar', function () {
    it('should be able to Authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeStorageProvider, updateUserAvata, user, resulte;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRespository = new FakeUsersRepository_1.default();
                    fakeStorageProvider = new FakeStorageProvider_1.default();
                    updateUserAvata = new updateUserAvatarService_1.default(fakeUserRespository, fakeStorageProvider);
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, updateUserAvata.execute({
                            user_id: user.id,
    ...
    it('should not be able to authenticate from non exist user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeHashProvider, authUser;
        return __generator(this, function (_a) {
            fakeUserRespository = new FakeUsersRepository_1.default();
            fakeHashProvider = new FakeHashProvider_1.default();
            authUser = new AuthenticateUserService_1.default(fakeUserRespository, fakeHashProvider);
    ...
    it('should delete old avatar when set new one', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeStorageProvider, deleteFile, updateUserAvata, user, resulte, resulte1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRespository = new FakeUsersRepository_1.default();
    ...
    it('should not be able to update from non exist user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeStorageProvider, updateUserAvata;
        return __generator(this, function (_a) {
            fakeUserRespository = new FakeUsersRepository_1.default();
            fakeStorageProvider = new FakeStorageProvider_1.default();
            updateUserAvata = new updateUserAvatarService_1.default(fakeUserRespository, fakeStorageProvider);
