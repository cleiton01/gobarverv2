...
describe('AuthenticateUser', function () {
    it('should be able to Authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeHashProvider, createUser, authUser, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRespository = new FakeUsersRepository_1.default();
                    fakeHashProvider = new FakeHashProvider_1.default();
                    createUser = new CreateUserService_1.default(fakeUserRespository, fakeHashProvider);
    ...
    it('should not be able to Authenticate with different password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeHashProvider, createUser, authUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRespository = new FakeUsersRepository_1.default();
    ...
    it('should not be able to Authenticate with different e-mail', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRespository, fakeHashProvider, createUser, authUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
